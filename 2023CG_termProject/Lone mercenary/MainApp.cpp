...
bool MainApp::e_arrayReady()
{
	...
	enemy_array.push_back(new NM_zombie(100, 200, 1, 30, 50, 일반));
	for (int i = 0; i < 4; ++i) {
		enemy_array.push_back(new NM_zombie(100, 200, 1, 10, 10, 힐러));
	}
	enemy_array.push_back(new NM_zombie(100, 200, 1, 20, 50, 폭발));
	return true;
}
